...
public class CopperHopperBlockEntity extends RandomizableContainerBlockEntity implements Hopper {
    ...
    public static final int MOVE_ITEM_SPEED = 10; //Base is 8
    private static final Component DEFAULT_NAME = Component.translatable("container.copper_hopper");
    // CUSTOM SETTINGS FOR NEW HOPPERS
    ...
    public CopperHopperBlockEntity(BlockPos blockPos, BlockState blockState) {
        super(ModBlockEntities.COPPER_HOPPER_BLOCK_ENTITY, blockPos, blockState);
    ...
    public static void pushItemsTick(Level level, BlockPos blockPos, BlockState blockState, CopperHopperBlockEntity hopperBlockEntity) {
    ...
    private static boolean tryMoveItems(
            Level level, BlockPos blockPos, BlockState blockState, CopperHopperBlockEntity hopperBlockEntity, BooleanSupplier booleanSupplier
    ) {
        if (level.isClientSide()) {
            return false;
        } else {
            if (!hopperBlockEntity.isOnCooldown() && (Boolean)blockState.getValue(CopperHopperBlock.ENABLED)) {
                boolean bl = false;
    ...
    private static boolean ejectItems(Level level, BlockPos blockPos, CopperHopperBlockEntity hopperBlockEntity) {
    ...
    private static ItemStack tryMoveInItem(@Nullable Container container, Container container2, ItemStack itemStack, int i, @Nullable Direction direction) {
        ...
        if (canPlaceItemInContainer(container2, itemStack, i, direction)) {
            ...
            if (bl) {
                if (bl2 && container2 instanceof CopperHopperBlockEntity hopperBlockEntity && !hopperBlockEntity.isOnCustomCooldown()) {
                    int k = 0;
                    if (container instanceof CopperHopperBlockEntity hopperBlockEntity2 && hopperBlockEntity.tickedGameTime >= hopperBlockEntity2.tickedGameTime) {
                        k = 1;
                    }
    ...
    @Nullable
    private static Container getAttachedContainer(Level level, BlockPos blockPos, CopperHopperBlockEntity hopperBlockEntity) {
    ...
    public static void entityInside(Level level, BlockPos blockPos, BlockState blockState, Entity entity, CopperHopperBlockEntity hopperBlockEntity) {
