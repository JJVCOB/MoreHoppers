...
public class NetheriteHopperBlockEntity extends RandomizableContainerBlockEntity implements Hopper {
    ...
    private static final Component DEFAULT_NAME = Component.translatable("container.netherite_hopper");
    // CUSTOM SETTINGS FOR NEW HOPPERS
    ...
    public NetheriteHopperBlockEntity(BlockPos blockPos, BlockState blockState) {
        super(ModBlockEntities.NETHERITE_HOPPER_BLOCK_ENTITY, blockPos, blockState);
    ...
    public void setBlockState(BlockState blockState) {
        ...
        this.facing = blockState.getValue(NetheriteHopperBlock.FACING);
    }
    ...
    public static void pushItemsTick(Level level, BlockPos blockPos, BlockState blockState, NetheriteHopperBlockEntity hopperBlockEntity) {
    ...
    private static boolean tryMoveItems(
            Level level, BlockPos blockPos, BlockState blockState, NetheriteHopperBlockEntity hopperBlockEntity, BooleanSupplier booleanSupplier
    ) {
        if (level.isClientSide()) {
            return false;
        } else {
            if (!hopperBlockEntity.isOnCooldown() && (Boolean)blockState.getValue(NetheriteHopperBlock.ENABLED)) {
                boolean bl = false;
    ...
    private static boolean ejectItems(Level level, BlockPos blockPos, NetheriteHopperBlockEntity hopperBlockEntity) {
    ...
    private static ItemStack tryMoveInItem(@Nullable Container container, Container container2, ItemStack itemStack, int i, @Nullable Direction direction) {
        ...
        if (canPlaceItemInContainer(container2, itemStack, i, direction)) {
            ...
            if (bl) {
                if (bl2 && container2 instanceof NetheriteHopperBlockEntity hopperBlockEntity && !hopperBlockEntity.isOnCustomCooldown()) {
                    int k = 0;
                    if (container instanceof NetheriteHopperBlockEntity hopperBlockEntity2 && hopperBlockEntity.tickedGameTime >= hopperBlockEntity2.tickedGameTime) {
                        k = 1;
                    }
    ...
    @Nullable
    private static Container getAttachedContainer(Level level, BlockPos blockPos, NetheriteHopperBlockEntity hopperBlockEntity) {
    ...
    public static void entityInside(Level level, BlockPos blockPos, BlockState blockState, Entity entity, NetheriteHopperBlockEntity hopperBlockEntity) {
