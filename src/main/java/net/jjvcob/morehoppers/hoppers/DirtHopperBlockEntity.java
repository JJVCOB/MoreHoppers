...
public class DirtHopperBlockEntity extends RandomizableContainerBlockEntity implements Hopper {

    // CUSTOM SETTINGS FOR NEW HOPPERS
    public static int MOVE_ITEM_SPEED = 24; //Base is 8
    public static Random rand = new Random();
    private static final Component DEFAULT_NAME = Component.translatable("container.dirt_hopper");
    // CUSTOM SETTINGS FOR NEW HOPPERS
    ...
    public DirtHopperBlockEntity(BlockPos blockPos, BlockState blockState) {
        super(ModBlockEntities.DIRT_HOPPER_BLOCK_ENTITY, blockPos, blockState);
    ...
    public void setBlockState(BlockState blockState) {
        ...
        this.facing = blockState.getValue(DirtHopperBlock.FACING);
    }
    ...
    public static void pushItemsTick(Level level, BlockPos blockPos, BlockState blockState, DirtHopperBlockEntity hopperBlockEntity) {
    ...
    private static boolean tryMoveItems(
            Level level, BlockPos blockPos, BlockState blockState, DirtHopperBlockEntity hopperBlockEntity, BooleanSupplier booleanSupplier
    ) {
        if (level.isClientSide()) {
            return false;
        } else {
            if (!hopperBlockEntity.isOnCooldown() && (Boolean)blockState.getValue(DirtHopperBlock.ENABLED)) {
                boolean bl = false;
                ...
                if (bl) {
                    MOVE_ITEM_SPEED = 24 + rand.nextInt(9);
    ...
    private static boolean ejectItems(Level level, BlockPos blockPos, DirtHopperBlockEntity hopperBlockEntity) {
    ...
    private static ItemStack tryMoveInItem(@Nullable Container container, Container container2, ItemStack itemStack, int i, @Nullable Direction direction) {
        ...
        if (canPlaceItemInContainer(container2, itemStack, i, direction)) {
            ...
            if (bl) {
                if (bl2 && container2 instanceof DirtHopperBlockEntity hopperBlockEntity && !hopperBlockEntity.isOnCustomCooldown()) {
                    int k = 0;
                    if (container instanceof DirtHopperBlockEntity hopperBlockEntity2 && hopperBlockEntity.tickedGameTime >= hopperBlockEntity2.tickedGameTime) {
                        k = 1;
                    }

                    hopperBlockEntity.setCooldown(MOVE_ITEM_SPEED - k);
                }
    ...
    @Nullable
    private static Container getAttachedContainer(Level level, BlockPos blockPos, DirtHopperBlockEntity hopperBlockEntity) {
    ...
    public static void entityInside(Level level, BlockPos blockPos, BlockState blockState, Entity entity, DirtHopperBlockEntity hopperBlockEntity) {
