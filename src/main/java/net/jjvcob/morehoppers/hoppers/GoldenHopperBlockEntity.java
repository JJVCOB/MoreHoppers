...
public class GoldenHopperBlockEntity extends RandomizableContainerBlockEntity implements Hopper {
    ...
    public static final int MOVE_ITEM_SPEED = 6; //Base is 8
    ...
    public GoldenHopperBlockEntity(BlockPos blockPos, BlockState blockState) {
        super(ModBlockEntities.GOLDEN_HOPPER_BLOCK_ENTITY, blockPos, blockState);
    ...
    public static void pushItemsTick(Level level, BlockPos blockPos, BlockState blockState, GoldenHopperBlockEntity hopperBlockEntity) {
    ...
    private static boolean tryMoveItems(
            Level level, BlockPos blockPos, BlockState blockState, GoldenHopperBlockEntity hopperBlockEntity, BooleanSupplier booleanSupplier
    ) {
        if (level.isClientSide()) {
            return false;
        } else {
            if (!hopperBlockEntity.isOnCooldown() && (Boolean)blockState.getValue(GoldenHopperBlock.ENABLED)) {
                boolean bl = false;
    ...
    private static boolean ejectItems(Level level, BlockPos blockPos, GoldenHopperBlockEntity hopperBlockEntity) {
    ...
    private static ItemStack tryMoveInItem(@Nullable Container container, Container container2, ItemStack itemStack, int i, @Nullable Direction direction) {
        ...
        if (canPlaceItemInContainer(container2, itemStack, i, direction)) {
            ...
            if (bl) {
                if (bl2 && container2 instanceof GoldenHopperBlockEntity hopperBlockEntity && !hopperBlockEntity.isOnCustomCooldown()) {
                    int k = 0;
                    if (container instanceof GoldenHopperBlockEntity hopperBlockEntity2 && hopperBlockEntity.tickedGameTime >= hopperBlockEntity2.tickedGameTime) {
                        k = 1;
                    }
    ...
    @Nullable
    private static Container getAttachedContainer(Level level, BlockPos blockPos, GoldenHopperBlockEntity hopperBlockEntity) {
    ...
    public static void entityInside(Level level, BlockPos blockPos, BlockState blockState, Entity entity, GoldenHopperBlockEntity hopperBlockEntity) {
