...
public class WoodenHopperBlockEntity extends RandomizableContainerBlockEntity implements Hopper {
    ...
    public static final int MOVE_ITEM_SPEED = 16; //Base is 8
    private static final Component DEFAULT_NAME = Component.translatable("container.wooden_hopper");
    // CUSTOM SETTINGS FOR NEW HOPPERS
    ...
    public WoodenHopperBlockEntity(BlockPos blockPos, BlockState blockState) {
        super(ModBlockEntities.WOODEN_HOPPER_BLOCK_ENTITY, blockPos, blockState);
    ...
    public void setBlockState(BlockState blockState) {
        ...
        this.facing = blockState.getValue(WoodenHopperBlock.FACING);
    }
    ...
    public static void pushItemsTick(Level level, BlockPos blockPos, BlockState blockState, WoodenHopperBlockEntity hopperBlockEntity) {
    ...
    private static boolean tryMoveItems(
            Level level, BlockPos blockPos, BlockState blockState, WoodenHopperBlockEntity hopperBlockEntity, BooleanSupplier booleanSupplier
    ) {
        if (level.isClientSide()) {
            return false;
        } else {
            if (!hopperBlockEntity.isOnCooldown() && (Boolean)blockState.getValue(WoodenHopperBlock.ENABLED)) {
                boolean bl = false;
    ...
    private static boolean ejectItems(Level level, BlockPos blockPos, WoodenHopperBlockEntity hopperBlockEntity) {
    ...
    private static ItemStack tryMoveInItem(@Nullable Container container, Container container2, ItemStack itemStack, int i, @Nullable Direction direction) {
        ...
        if (canPlaceItemInContainer(container2, itemStack, i, direction)) {
            ...
            if (bl) {
                if (bl2 && container2 instanceof WoodenHopperBlockEntity hopperBlockEntity && !hopperBlockEntity.isOnCustomCooldown()) {
                    int k = 0;
                    if (container instanceof WoodenHopperBlockEntity hopperBlockEntity2 && hopperBlockEntity.tickedGameTime >= hopperBlockEntity2.tickedGameTime) {
                        k = 1;
                    }
    ...
    @Nullable
    private static Container getAttachedContainer(Level level, BlockPos blockPos, WoodenHopperBlockEntity hopperBlockEntity) {
    ...
    public static void entityInside(Level level, BlockPos blockPos, BlockState blockState, Entity entity, WoodenHopperBlockEntity hopperBlockEntity) {
