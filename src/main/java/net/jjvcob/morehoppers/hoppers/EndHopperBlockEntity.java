...
public class EndHopperBlockEntity extends RandomizableContainerBlockEntity implements Hopper {

    // CUSTOM SETTINGS FOR NEW HOPPERS
    public static final int MOVE_ITEM_SPEED = 1; //Base is 8
    private static final Component DEFAULT_NAME = Component.translatable("container.end_hopper");
    // CUSTOM SETTINGS FOR NEW HOPPERS
    ...
    public EndHopperBlockEntity(BlockPos blockPos, BlockState blockState) {
        super(ModBlockEntities.END_HOPPER_BLOCK_ENTITY, blockPos, blockState);
    ...
    public void setBlockState(BlockState blockState) {
        ...
        this.facing = blockState.getValue(EndHopperBlock.FACING);
    }
    ...
    public static void pushItemsTick(Level level, BlockPos blockPos, BlockState blockState, EndHopperBlockEntity hopperBlockEntity) {
    ...
    private static boolean tryMoveItems(
            Level level, BlockPos blockPos, BlockState blockState, EndHopperBlockEntity hopperBlockEntity, BooleanSupplier booleanSupplier
    ) {
        if (level.isClientSide()) {
            return false;
        } else {
            if (!hopperBlockEntity.isOnCooldown() && (Boolean)blockState.getValue(EndHopperBlock.ENABLED)) {
                for (int i = 0; i < 4; i++) {
                    boolean bl = false;
    ...
    private static boolean ejectItems(Level level, BlockPos blockPos, EndHopperBlockEntity hopperBlockEntity) {
    ...
    private static ItemStack tryMoveInItem(@Nullable Container container, Container container2, ItemStack itemStack, int i, @Nullable Direction direction) {
        ...
        if (canPlaceItemInContainer(container2, itemStack, i, direction)) {
            ...
            if (bl) {
                if (bl2 && container2 instanceof EndHopperBlockEntity hopperBlockEntity && !hopperBlockEntity.isOnCustomCooldown()) {
                    int k = 0;
                    if (container instanceof EndHopperBlockEntity hopperBlockEntity2 && hopperBlockEntity.tickedGameTime >= hopperBlockEntity2.tickedGameTime) {
                        k = 1;
                    }
    ...
    @Nullable
    private static Container getAttachedContainer(Level level, BlockPos blockPos, EndHopperBlockEntity hopperBlockEntity) {
    ...
    public static void entityInside(Level level, BlockPos blockPos, BlockState blockState, Entity entity, EndHopperBlockEntity hopperBlockEntity) {
